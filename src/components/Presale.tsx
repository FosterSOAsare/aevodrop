	...
	return (
		<section className="py-24">
			<div className="w-full max-w-4xl mx-auto  flex items-center justify-center flex-col">
				...
				<div className="w-1/2 rounded-[5px] bg-[#1A1B26] p-6 flex flex-col items-center justify-center">
