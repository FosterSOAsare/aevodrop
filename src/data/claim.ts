...
const claims: IClaim[] = [
  {
    ...
    list: [
      ...
      "Each person can invite unlimited people."
    ]
  }
  , {
  ...
  },
  {
    ...
    list: [
      ...
      "Pre-sale price 1 BNB = 25,000 AEVO. Mini buy 0.1 BNB, Max buy 100 BNB.",
      "Use your wallet to send BNB to the presale address provided on this platform. Our system will automatically send AEVO tokens to your wallet instantly. You can send BNB any amount."
    ]
  }, {
